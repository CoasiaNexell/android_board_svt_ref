...
# input
PRODUCT_COPY_FILES += \
	device/nexell/svt_ref/TSC2007_Touchscreen.idc:system/usr/idc/TSC2007_Touchscreen.idc \
...
# wallpaper
PRODUCT_COPY_FILES += \
	device/nexell/svt_ref/wallpaper:/data/system/users/0/wallpaper \
	device/nexell/svt_ref/wallpaper_orig:/data/system/users/0/wallpaper_orig \
	device/nexell/svt_ref/wallpaper_info.xml:/data/system/users/0/wallpaper_info.xml
...
PRODUCT_COPY_FILES += \
	device/nexell/svt_ref/media_codecs_ffmpeg.xml:system/etc/media_codecs.xml
else
PRODUCT_COPY_FILES += \
...
PRODUCT_COPY_FILES += \
	...
	device/nexell/svt_ref/pointercal:system/etc/pointercal
...
PRODUCT_COPY_FILES += \
	device/nexell/svt_ref/iproxy.sh:system/bin/iproxy.sh
